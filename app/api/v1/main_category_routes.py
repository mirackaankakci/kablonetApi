...
from app.schemas.main_category_schema import MainCategoryResponse, MainCategoryCreateResponse, MainCategoryUpdateResponse, MainCategoryUpdate, DeleteMainCategoryResponse
...
@router.delete("/{main_category_id}", response_model= DeleteMainCategoryResponse)
def deactivate_main_category(main_category_id: int, db: Session = Depends(get_db)):
