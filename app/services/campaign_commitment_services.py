...
def get_all_campaign_commitments_campaign_service(campaign_id: int):
    return get_all_campaign_commitments_campaign_from_db(campaign_id)
...
def get_all_campaign_commitments_service(db: Session):
    return get_all_campaign_commitments_from_db(db)