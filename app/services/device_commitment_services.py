from app.crud.device_commitment_crud import get_device_commitment_by_id_from_db, create_device_commitment_from_db, update_device_commitment_from_db, get_all_device_commitments_from_db

def get_all_device_commitments_service(device_id: int):
    return get_all_device_commitments_from_db(device_id)
